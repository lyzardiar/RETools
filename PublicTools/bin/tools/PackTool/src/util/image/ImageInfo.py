...
TYPE_MAP = { 
        re.compile(r'^\xFF\xD8')              : ('JPEG', _jpegsize),
...
TYPE_MAP = { 
        b'\xFF\xD8'              : ('JPEG', _jpegsize),
        b'BM'                         : ('BMP',  _bmpsize),
        b'\x89PNG\x0d\x0a\x1a\x0a'    : ('PNG',  _pngsize),
        b'GIF8[7,9]a'                 : ('GIF',  _gifsize),
        b'P[1-7]'                     : ('PPM',  _ppmsize),
        b'\#define\s+\S+\s+\d+'        : ('XBM',  _xbmsize),
        b'\/\* XPM \*\/'               : ('XPM',  _xpmsize),
        b'MM\x00\x2a'                 : ('TIFF', _tiffsize),
        b'II\x2a\x00'                 : ('TIFF', _tiffsize),
        b'8BPS'                       : ('PSD',  _psdsize),
        b'PCD_OPA'                    : ('PCD',  _pcdsize),
        b'FWS'                        : ('SWF',  _swfsize),
        b'CWS'                        : ('SWF',  _swfmxsize),
        b'\x8aMNG\x0d\x0a\x1a\x0a'    : ('MNG',  _mngsize),
        b'\x01\xDA[\x01\x00]'         : ('RGB',  _rgbsize),
        b'\x59\xA6\x6A\x95'           : ('RAS',  _rassize),
        b'\x0A.\x01'                  : ('PCX',  _pcxsize),
        b'svg\s'                       : ('SVG',  _svgsize)
}
...
# print(size(r"I:\Workspace\Mobilephone_DDT\trunk\Client\Develop\Resource\100601.jpg"))